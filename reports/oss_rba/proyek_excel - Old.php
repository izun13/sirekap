...
$header = array("No.","NIB","Nama Perusahaan","Judul KBLI","Sektor","Realisasi Investasi","TKI","TKA");
...
$objPHPExcel->getActiveSheet()->setCellValue('B6',"PENANAM MODAL/INVESTOR BARU"); 
	...
	$tabel = "SELECT id,id_proyek,nib,nama_perusahaan,judul_kbli,sektor,tambah_investasi,tki FROM view_proyek WHERE verifikasi = 'Terverifikasi' AND status_perusahaan = 'Baru' AND tambah_investasi != '0' AND 
			tgl_verifikasi >= '$search1' AND tgl_verifikasi <= '$search2' ORDER BY nama_perusahaan asc";	
	...
	$tabel = "SELECT id,id_proyek,nib,nama_perusahaan,judul_kbli,sektor,tambah_investasi,tki,status_kbli FROM view_proyek WHERE verifikasi = 'Terverifikasi' AND status_perusahaan = 'Lama' AND tambah_investasi != '0' AND 
			tgl_verifikasi >= '$search1' AND tgl_verifikasi <= '$search2' ORDER BY status_kbli asc,nama_perusahaan asc";	
	$query = mysql_query($tabel);
