...
$id = $_GET["id"];
	...
	$tabel = "SELECT*FROM view_permohonan_izin_tte WHERE id = '$id' ";	
	...
	while ($r = mysql_fetch_array($query)){
		...
		$tabels2[$i]['<b>Lama Proses</b>']= $hari;
		$i++;
	}
		...
		$tabels2[$i]['<b>Lama Proses</b>']= "<b>".$hari_kerja." hari </b>";
	...
	$pdf->ezTable($tabels2,'', '', 
				array(	'shaded'=>1,'showLines'=>1,'showHeadings'=>1,'fontSize'=>10,'titleFontSize'=>10,'xPos'=>50,'xOrientation'=>'right','rowGap'=>5,
						'cols'=>array('<b>No.</b>'=>array ( 'width'=>30, 'justification'=>'center'),
										...
										'<b>Diubah Oleh</b>'=>array ( 'width'=>75, 'justification'=>'center'),
										'<b>Tgl Diubah</b>'=>array ( 'width'=>60, 'justification'=>'center'),
    ...
    //$pdf->ezStream();
    $pdf->ezStream(array('Content-Disposition'=>'Detil Proses Permohonan Izin.pdf'));
