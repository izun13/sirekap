...
if (($search3 == "") and ($opd_id != 1) and ($opd_id != 0)){ 
    ...
    // Set margin dan font
    $pdf->ezSetCmMargins(1.25,1,1.25,1);
	...
	else $pdf->ezText("<b>DAFTAR PENERBITAN PERIZINAN</b>",14,array('justification'=>'center'));
	...
	$sumber = "https://ws.sicantik.go.id/api/TemplateData/keluaran/37133.json";
		...
		foreach ($data["data"]["data"] as $key=>$r) {
			...
			if($tampil){	
				...
				if($tampil2){
					...
					$tabels[$i]['<b>Nama Perusahaan</b>']= $usaha;
					$tabels[$i]['<b>Jenis Izin</b>']= $r['jenis_izin'];
					$tabels[$i]['<b>Jenis Permohonan</b>']= $r['jenis_permohonan'];
					$tabels[$i]['<b>Telp./HP. Pemohon</b>']= $contact; 
					$tabels[$i]['<b>Jenis Reklame</b>']= $r['jenis_reklame'];
					$tabels[$i]['<b>Isi Reklame</b>']= $r['isi_reklame'];
					$tabels[$i]['<b>Ukuran Reklame</b>']= $r['ukuran'];
	...
	$pdf->ezTable($tabels,'', '', 
				array(	'shaded'=>1,'showLines'=>1,'showHeadings'=>1,'fontSize'=>10,'titleFontSize'=>10,'xPos'=>0,'xOrientation'=>'right','rowGap'=>5,
						'cols'=>array('<b>No.</b>'=>array ( 'width'=>30, 'justification'=>'center'),
										...
										'<b>Nama Perusahaan</b>'=>array ( 'width'=>80, 'justification'=>'left'),
										'<b>Jenis Izin</b>'=>array ( 'width'=>80, 'justification'=>'left'),
										'<b>Jenis Permohonan</b>'=>array ( 'width'=>65, 'justification'=>'left'),
										'<b>Telp./HP. Pemohon</b>'=>array ( 'width'=>70, 'justification'=>'left'),
										'<b>Jenis Reklame</b>'=>array ( 'width'=>80, 'justification'=>'left'),
										'<b>Isi Reklame</b>'=>array ( 'width'=>70, 'justification'=>'left'),
										'<b>Ukuran Reklame</b>'=>array ( 'width'=>60, 'justification'=>'left'),
										'<b>Lokasi Reklame</b>'=>array ( 'width'=>130, 'justification'=>'full'),//'full'
										'<b>Nomor Izin</b>'=>array ( 'width'=>80, 'justification'=>'left'),
										'<b>Tanggal Penetapan</b>'=>array ( 'width'=>60, 'justification'=>'center'),
    ...
    //$pdf->ezStream();
	$pdf->ezStream(array('Content-Disposition'=>'Rekap Penerbitan Izin.pdf'));
