...
$jns_izin = mysql_fetch_array(mysql_query("SELECT*FROM jenis_izin WHERE id='$search3'"));
	...
	if($search3)$pdf->ezText("<b><u>".STRTOUPPER($jns_izin['jenis_izin'])."</u></b>",14,array('justification'=>'center'));
	...
	$pdf->ezTable($tabels,'', '', 
				array(	'shaded'=>1,'showLines'=>1,'showHeadings'=>1,'fontSize'=>11,'titleFontSize'=>11,'xPos'=>0,'xOrientation'=>'right','rowGap'=>5,
						'cols'=>array('<b>No.</b>'=>array ( 'width'=>50, 'justification'=>'center'),
										...
										'<b>Lokasi Izin</b>'=>array ( 'width'=>260, 'justification'=>'full'),//'full'
										'<b>Nomor Izin</b>'=>array ( 'width'=>145, 'justification'=>'left'),
	...
	//$pdf->ezText('Koordinator Pelayanan Perizinan dan',12,array('left'=>500,'justification'=>'center'));
	...
	//$pdf->ezText("<u><b>VIVI ERI SETYOWATI, SE.</b></u>",12,array('left'=>500,'justification'=>'center'));
	//$pdf->ezText("NIP. 19760524 199903 2 004",12,array('left'=>500,'justification'=>'center'));
