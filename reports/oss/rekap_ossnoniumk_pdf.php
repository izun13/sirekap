...
if($_GET["group"])$group = $_GET["group"];
	...
	$pdf->ezText("<b><u>REKAPITULASI NON IUMK OSS</u></b>",14,array('justification'=>'center'));
	...
	$tabel = "SELECT*FROM oss_noniumk WHERE id IS NOT NULL";
	...
	//nama_perusahaan,nib,tanggal_nib,status_pm,kbli,nama_izin,tanggal_izin,uraian,investasi,tenaga_kerja
		...
		while ($r = mysql_fetch_array($query)){
			...
			$tabels[$i]['<b>Tanggal NIB</b>']= tgl1($r['tanggal_nib']);
			$tabels[$i]['<b>Status PM</b>']= $r['status_pm'];
			$tabels[$i]['<b>KBLI</b>']= $r['kbli'];
			$tabels[$i]['<b>Kegiatan Usaha</b>']= $r['nama_izin'];
			$tabels[$i]['<b>Tanggal Izin</b>']= tgl1($r['tanggal_izin']);
			$tabels[$i]['<b>Uraian</b>']= $r['uraian'];
			$tabels[$i]['<b>Investasi</b>']= rupiah($r['investasi']);
			$tabels[$i]['<b>Jumlah Naker</b>']= $r['tenaga_kerja'];
			$i++;
	...
	$pdf->ezTable($tabels,'', '', 
				array(	'shaded'=>1,'showLines'=>1,'showHeadings'=>1,'fontSize'=>11,'titleFontSize'=>11,'xPos'=>0,'xOrientation'=>'right','rowGap'=>5,
						'cols'=>array('<b>No.</b>'=>array ( 'width'=>40, 'justification'=>'center'),
										...
										'<b>Status PM</b>'=>array ( 'width'=>60, 'justification'=>'center'),
										'<b>KBLI</b>'=>array ( 'width'=>50, 'justification'=>'center'),
										'<b>Kegiatan Usaha</b>'=>array ( 'width'=>130, 'justification'=>'full'),//'full'
										'<b>Tanggal Izin</b>'=>array ( 'width'=>80, 'justification'=>'center'),
										'<b>Uraian</b>'=>array ( 'width'=>80, 'justification'=>'left'),
										'<b>Investasi</b>'=>array ( 'width'=>100, 'justification'=>'right'),
