...
if($act == "Tampilkan"){
	...
	$searchlink = "$search1;$search2;$search3";
	...
	echo"&nbsp; <a href='reports/sicantik/rekap_statistik_tte_json.php?send=$search1;$search2'  target='_blank'><img src=\"img/json.png\" width='38' title='Cetak Json'></img></a>";
	...
	<table class="tabelbox1" width="800">
		...
		$tabel = "SELECT count(jenis_izin) as jumlah,jenis_izin FROM permohonan_izin_tte WHERE no_permohonan NOT LIKE '%EXP%' AND no_permohonan NOT LIKE '%TEST%' AND status_penetapan != 'ditolak'";	
		...
		while ($r= mysql_fetch_array($query)){
			...
			$tabel2 = "SELECT id,end_date FROM permohonan_izin_tte WHERE del != '1' AND no_permohonan NOT LIKE '%EXP%' AND no_permohonan NOT LIKE '%TEST%' AND status_penetapan != 'ditolak'";	
