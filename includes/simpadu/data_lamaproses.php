...
?>
<div class="judul">Rekap Proses Perizinan Simpadu (oss.magelangkota.go.id)</div>
...
if($act == "Tampilkan"){
	...
	//echo $tabel;
		...
		$search = $search1.";".$search2.";".$search3x.";".$search4.";".$search5;
		page($query,$recpage,$starting,$to_page,$search,$act);
		
		echo"<a href='reports/simpadu/rekap_lamaproses_excel.php?search1=$search1&search2=$search2&search3=$search3&search4=$search4&search5=$search5&opd=$opd_id'><img src=\"img/excel.png\" width='50' title='cetak excel'></img></a>";
		echo"&nbsp; <a href='reports/simpadu/rekap_lamaproses_pdf.php?search1=$search1&search2=$search2&search3=$search3&search4=$search4&search5=$search5&opd=$opd_id'  target='_blank'><img src=\"img/pdf.png\" width='38' title='cetak PDF'></img></a>";
...
?>
	<table class="tabelbox1" width="800">
		<tr>
			...
			<th><b>ID</b></th>
			<th><b>Nomor</b></th>
			<th><b>Tanggal Menerima Berkas</b></th>
		...
		if(($search5 == 5) or ($search5 == 6)) $query = mysql_query($tabel);	
		...
		//$tglakhir = mysql_fetch_array(mysql_query("SELECT permproc_date FROM permohonan_process WHERE permproc_permohonan_id = '$r[permohonan_id]' AND permproc_statusproses_id = '7' "));
			...
			if($tampil == 1){
				...
				echo "<td align='left'>$r[permohonan_id]</td>";
				echo "<td align='left'>$r[permohonan_nomor_urut]</td>";
				echo "<td align='center'>$tgl1</td>";
				echo "<td align='left'>$r[jenisizin_name]</td>";
				echo "<td align='left'>$r[statusizin_name]</td>";
				echo "<td align='left'>$r[pemohon_nama]</td>";
				echo "<td align='left'>$r[pemohon_telepon]</td>";
				echo "<td align='left'>$r[pemohon_alamat]</td>";
				echo "<td align='left'>$r[permohonan_nomor_surat]</td>";
				echo "<td align='center'>$tgl2</td>";
				//echo "<td align='center'>$r[permohonan_tgl_berakhir_izin]</td>";
