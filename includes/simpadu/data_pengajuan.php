...
?>
<div class="judul">Rekap Permohonan Perizinan Simpadu (oss.magelangkota.go.id)</div>

<form action='<?php echo "?send=".$to_page;?>' method='post' autocomplete="off"> 
<table width="">
	<tr><td width="200">Periode Tanggal Pendaftaran </td><td>:</td>
...
//if($act == "Tampilkan"){
	...
	if(($search1 != "") and ($search2 != "")) $tabel .= " and permohonan_tgl_daftar >= '$search1' and permohonan_tgl_daftar <= '$search2'";
	...
	<table class="tabelbox1" width="800">
		...
		//permohonan_tgl_izin,permohonan_tgl_berakhir_izin,permohonan_retribusi,permohonan_tarif,permohonan_keterangan
			...
			echo "
			  ...
			  <td align='center'>".tgl1($r['permohonan_tgl_daftar'])."</td>
			  <td align='center'>".tgl1($r['permohonan_tgl_izin'])."</td>";
