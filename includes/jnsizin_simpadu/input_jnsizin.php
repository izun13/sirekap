...
$tabel2 = "SELECT jenisizin_name,jenisizin_singkatan,jenisizin_opd_id FROM jenis_izin WHERE jenisizin_id='$id'";					
$query = mysql_query($tabel2);

if($_POST["submit"]=="BATAL"){
	?>
	<script language="JavaScript">
		document.location.href='?send=jns-izinsimp//<?php echo $starting; ?>/<?php echo $search; ?>';
	</script>
	<?php
}
...
if($_POST["submit"]=="SIMPAN"){
	...
	//}else{
		$ubah="update jenis_izin set $update where jenisizin_id='$id'";
