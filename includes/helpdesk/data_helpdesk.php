...
$tabel = "SELECT*FROM tb_helpdesk WHERE id IS NOT NULL";	
?>	
		
<div><span class='judul'>Data Helpdesk</span></div>
<table width="100%">
<tr><td>
...
<td width="230px">
	...
	<td valign="center"><input type='text' name='search2' size='20' value='<?php echo $search2;?>'>
		...
		<td align="right">
		<a href="?send=inputhelpdesk"><img src="img/tambah.png" width="30" title="tambah"></img></a>
	</td>
</tr>
<?php
//}
...
* Klik judul kolom untuk mengurutkan.
	<table class="tabelbox1">
		...
		for($i = 0; $i < mysql_num_fields($query); $i++){
			...
			$urutkan = $name.$order;
			if($name!="id")echo "<th><a href='?send=$to_page////$urutkan'>$title</a></th>";
		}
		...
		while ($r= mysql_fetch_array($query)){
			...
			echo "<td align='center'><a href='?send=inputhelpdesk/$id/$starting/$search'><img src=\"img/edit.png\" width='25' title='ubah'></img></a></td>";
