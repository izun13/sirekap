...
<div><span class='judul'>Data OSS RBA Proyek</span></div>
...
//"bangunan_gedung","modal_kerja","lain_lain","tki",tgl_verifikasi, uraian_jenis_perizinan,sektor,
$tabel = "SELECT id,nama_perusahaan,nib,uraian_status_penanaman_modal,uraian_jenis_perusahaan,uraian_risiko_proyek,uraian_skala_usaha,
		kbli,judul_kbli,nama_proyek,jumlah_investasi,tambah_investasi,tki,status_perusahaan,verifikasi,tgl_verifikasi FROM view_proyek WHERE id IS NOT NULL";	//day_of_tgl_izin,uraian_jenis_perizinan,
...
echo "<input type='radio' name='group' value='' onchange='tampilkan()' $checked> Semua ";*/
	...
	echo"<a href='reports/oss_rba/rekap_ossrbaproyek_excel.php?search=$search&act=$group' target='_blank'><img src=\"img/excel.png\" width='50' title='cetak excel'></img></a>";
