...
<table>
	<tr><td width="200">Periode Tanggal Pengesahan (TTE) </td><td>:</td>
...
if($act == "Tampilkan"){
	...
	<table class="tabelbox1" width="800">
		...
		for($x=0;$x<count($bulan);$x++){
			...
			if($tte[$x] == 1) $query = "SELECT*FROM view_permohonan_izin_tte WHERE del != '1' AND no_permohonan NOT LIKE '%EXP%' AND no_permohonan NOT LIKE '%TEST%' AND end_date LIKE '%$bulan[$x]%'";
