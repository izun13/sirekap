...
$tabel = "SELECT kbli.id as id,kbli.uraian as uraian,sektor.sektor as sektor FROM kbli LEFT JOIN sektor ON kbli.sektor_id = sektor.sektor_id WHERE kbli.id IS NOT NULL";	
		
?>	
		
<div><span class='judul'>Data Klasifikasi Baku Lapangan Usaha Indonesia (KBLI)</span></div>
<table width="100%">
<tr><td>
...
<td width='' align="right">
		<?php //echo "<a href='?send=inputkbli'><img src='img/tambah.png' width='30' title='tambah'></img></a>"; ?>
</td>
</tr>
</table>
</form>
...
* Klik judul kolom untuk mengurutkan.
	<table class="tabelbox1">
		...
		while ($r= mysql_fetch_array($query)){
			...
			//echo "<td align='center'><a href='?send=inputkbli/$id/$starting/$search'><img src=\"img/edit.png\" width='25' title='ubah'></img></a></td>";
			echo "</tr>";
			$baris++;
		}
		?>
