...
$tabel = "SELECT*FROM data_investasi WHERE id IS NOT NULL";	
		
?>	
		
<div><span class='judul'>Daftar Investasi</span></div>
<table width="100%">
<tr><td>
...
<td width="230px">
	...
	<td valign="center"><input type='text' name='search2' size='20' value='<?php echo $search2;?>'>
		...
		<?php echo "<a href='?send=inputinvestasi'><img src='img/tambah.png' width='30' title='tambah'></img></a>"; ?>
</td>
</tr>
</table>
</form>
...
* Klik judul kolom untuk mengurutkan.
	<table class="tabelbox1">
		...
		while ($r= mysql_fetch_array($query)){
			...
			echo "<a href='?send=inputinvestasi/$id/$starting/$search'><img src=\"img/edit.png\" width='25' title='ubah'></img></a>";
			echo "<a href='?send=updateinvestasi/$id/$starting/$search'><img src=\"img/updates.png\" width='25' title='update'></img></a>";
			echo "</td>";
			echo "</tr>";
			$baris++;
		}
